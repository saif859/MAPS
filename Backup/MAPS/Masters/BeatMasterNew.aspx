<%@ Page Title="Beat New/ Edit" Language="C#" MasterPageFile="~/Masters/Site1.Master"
    AutoEventWireup="true" CodeBehind="BeatMasterNew.aspx.cs" Inherits="MAPS.Masters.BeatMasterNew" %>
            ...
            <asp:UpdatePanel ID="up" runat="server">
                <ContentTemplate>
                    <div class="perp_sheet perp_sheet_width">
                        <h1>
                            <span style="color: #06F;">Beat</span><span class="sa_fade">/ </span><span class="sa_breadcrumb_item">
                                <%if (Request["Code"] == null)
                                  { %>New<%}
                                  else
                                  { %><%=txtSectionName.Text%><%} %></span></h1>
                        <hr />
                                ...
                                <tr class="perp_group_row">
                                    ...
                                    <td class="perp_group_cell">
                                        <span class="perp_field perp_field_char">
                                            <asp:TextBox ID="txtSectionName" runat="server" MaxLength="250" Width="150px"></asp:TextBox>
                                        </span>
                                    </td>
                                    <td class="perp_group_cell perp_group_cell_label">
                                        <label for="" class=" perp_label sa_text_right">
                        ...
                        <div class="butLink03">
                            ...
                            <span class="sa_fade">or</span> <a accesskey="D" class="sa_bold perp_button_cancel"
                                href="SectionMaster.aspx">Discard</a>
                        </div>
                        <br />
                        <br />
                    </div>
