<%@ Page Language="C#" Title="Add New Village" MasterPageFile="~/Masters/Site1.Master"
    AutoEventWireup="True" CodeBehind="AddNewVillage.aspx.cs" Inherits="MAPS.AddNewVillage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="mainSection">
        <h1 style="padding-top: 10px;">
            <span class="heading">Village associated with
                <%:Request["vCode"] %></span>
        </h1>
        <div class="butLink01">
        </div>
                    ...
                    <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="District">
                                ...
                                <EditItemTemplate>
                                    <asp:DropDownList ID="ddlDistrictt" runat="server" SelectedValue='<%# Eval("DistrictId") %>'
                                        AutoPostBack="true" DataValueField="Id" DataTextField="DistrictName" ValidationGroup="U"
                                        DataSourceID="EntityDataSource1" OnSelectedIndexChanged="ddlDistrictt_SelectedIndexChanged1">
                                    </asp:DropDownList>
                                </EditItemTemplate>
                                <FooterTemplate>
                                    <asp:DropDownList ID="ddlDistrict" runat="server" ValidationGroup="U" AutoPostBack="true"
                            ...
                            <asp:TemplateField HeaderText="Tehsil">
                                ...
                                <EditItemTemplate>
                                    ...
                                    <asp:DropDownList ID="ddlTehsill" runat="server" DataValueField="Id" DataTextField="TehsilName"
                                        ValidationGroup="U">
                                    </asp:DropDownList>
                                </EditItemTemplate>
                                <FooterTemplate>
                            ...
                            <asp:TemplateField HeaderText="Add Khasara">
                                <ItemTemplate>
                                    <a href="AddKhasara.aspx?Code=<%# Request["Code"] %>&vCode=<%# Eval("Id") %>&b=<%# Request["vCode"] %>&v=<%# Eval("VillageName") %>">
                                        Add Khasara</a>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                                ...
                                <tr class="selected">
                                    ...
                                    <td align="center">
                                        <asp:DropDownList ID="ddlDistrict" runat="server" DataValueField="Id" DataTextField="DistrictName"
                                            AutoPostBack="true" ValidationGroup="U" OnSelectedIndexChanged="ddlDistrict_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </td>
                                    <td align="center">
                                        <asp:DropDownList ID="ddlTehsil" runat="server" DataValueField="Id" DataTextField="TehsilName"
