<%@ Page Title="Forest Area" Language="C#" MasterPageFile="~/Masters/Site1.Master"
    AutoEventWireup="true" CodeBehind="ForestArea2.aspx.cs" Inherits="MAPS.ForestArea2" %>
    ...
    <asp:UpdatePanel ID="upGV" runat="server">
        <ContentTemplate>
            ...
            <div class="mainSection">
                <h1>
                    <span class="heading">वन क्षेत्र (खंभे उपलब्ध नहीं)</span></h1>
                <div class="butLink01">
                    <a href="ForestAreaNew2.aspx" class="button">वन क्षेत्र जोड़ें</a>
                </div>
                <div class="butLink02">
                </div>
                <div class="butLink03">
                    ...
                    <div class="perp_sheet perp_sheet_width">
                        ...
                        <div id="hubData" class="tableContainer">
                            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" OnRowDeleting="GridView1_RowDeleting"
                                ...
                                ShowHeaderWhenEmpty="true" AllowPaging="true" PageSize="50" ShowFooter="false"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="वन प्रकार">
                                        <ItemTemplate>
                                            <%#Eval("ForestType").ToString() == "R" ? "Reserved" : (Eval("ForestType").ToString() == "U" ? "Protected" : (Eval("ForestType").ToString() == "C" ? "Cadastral" : "Other"))%>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                            <b>
                                    ...
                                    <asp:BoundField DataField="AreaInGazette" HeaderText="राजपत्र में क्षेत्रफल (एकड़ में)"
                                    ...
                                    <asp:TemplateField HeaderText="स्तम्भ विस्तार से देखें">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="राजपत्र/दस्तावेज़ विस्तार से लिखें">
                                        <ItemTemplate>
                                            <a href='DocumentDetail.aspx?Code=<%#Eval("Id") %>'>Enter</a>
                                        </ItemTemplate>
                                        <ItemStyle Width="10px" HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="राजपत्र विस्तार से देखें">
                                        <ItemTemplate>
                                    ...
                                    <asp:CommandField DeleteText="&lt;img src='images/btn_iconDelete.gif' alt='Delete' border='0' /&gt;"
                                        SelectText="Delete" ShowDeleteButton="True" HeaderText="हटाएं">
                                        <ItemStyle Width="10px" HorizontalAlign="Center" />
                                    </asp:CommandField>
                                </Columns>
                            </asp:GridView>
