<%@ Page Title="" Language="C#" MasterPageFile="~/View/Site1.Master" AutoEventWireup="true"
    CodeBehind="ForestArea.aspx.cs" Inherits="MAPS.View.ForestArea" %>
                        ...
                        <div id="hubData" class="tableContainer">
                            <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" OnRowDeleting="GridView1_RowDeleting"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="NumberOfPillars" HeaderText="स्तम्भों की संख्या" ItemStyle-HorizontalAlign="Right"
                                        FooterText="कुल क्षेत्रफल" FooterStyle-Font-Bold="true"></asp:BoundField>
                                    <asp:TemplateField HeaderText="गणना क्षेत्रफल (एकड़ में)" ItemStyle-HorizontalAlign="Right"
                                    ...
                                    <asp:BoundField DataField="AreaInGazette" HeaderText="राजपत्र में क्षेत्रफल" ItemStyle-HorizontalAlign="Right">
                                    </asp:BoundField>
