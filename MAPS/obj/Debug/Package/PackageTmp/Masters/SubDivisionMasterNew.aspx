<%@ Page Title="Sub Division" Language="C#" MasterPageFile="~/Masters/Site1.Master"
    AutoEventWireup="true" CodeBehind="SubDivisionMasterNew.aspx.cs" Inherits="MAPS.Masters.SubDivisionMasterNew" %>
            ...
            <asp:UpdatePanel ID="up" runat="server">
                <ContentTemplate>
                    <div class="perp_sheet perp_sheet_width">
                        <h1>
                            <span style="color: #06F;">Sub Division</span><span class="sa_fade">/ </span><span
                                class="sa_breadcrumb_item">
                                <%if (Request["Code"] == null)
                                  { %>New<%}
                                  else
                                  { %><%=txtDivisionName.Text%><%} %></span></h1>
                        <hr />
                        <table border="0" class="perp_group" cellspacing="0" cellpadding="0">
                            <tbody>
                                <tr class="perp_group_row">
                                    ...
                                    <td class="perp_group_cell">
                                        <span class="perp_field perp_field_char">
                                            <asp:TextBox ID="txtDivisionName" runat="server" MaxLength="250" Width="150px"></asp:TextBox>
                                        </span>
                                    </td>
                                    <td class="perp_group_cell perp_group_cell_label">
                                        <label for="" class=" perp_label sa_text_right">
                                ...
                                <tr class="perp_group_row">
                                    ...
                                    <td class="perp_group_cell perp_group_cell_label">
                                        &nbsp;<label class=" perp_label sa_text_right" for="">Officer Name</label>
                                    </td>
                                    <td class="perp_group_cell">
                                        &nbsp;<span class="perp_field perp_field_char"><asp:TextBox ID="txtOfficerName" runat="server"
                                            MaxLength="250" Width="120px"></asp:TextBox>
                                        </span>&nbsp;
                                    </td>
                                </tr>
                                <%if (Request["Code"] == null)
                        ...
                        <div class="butLink03">
                            ...
                            <span class="sa_fade">or</span> <a accesskey="D" class="sa_bold perp_button_cancel"
                                href="DivisionMaster.aspx">Discard</a>
                        </div>
                        <br />
                        <br />
                    </div>
