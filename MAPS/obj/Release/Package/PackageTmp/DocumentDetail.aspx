<%@ Page Title="Document Details" Language="C#" MasterPageFile="~/Masters/Site1.Master"
    AutoEventWireup="true" CodeBehind="DocumentDetail.aspx.cs" Inherits="MAPS.DocumentDetail" %>
                ...
                <div id="hubData" class="tableContainer">
                    <asp:GridView ID="gvShow" runat="server" Width="100%" EmptyDataText="No Records to Display."
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Gazette/Doc. Page Number">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Upload Gazette/Doc. Copy">
                                <ItemTemplate>
