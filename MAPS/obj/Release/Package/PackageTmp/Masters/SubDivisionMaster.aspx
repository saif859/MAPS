<%@ Page Title="Sub Division" Language="C#" MasterPageFile="~/Masters/Site1.Master" AutoEventWireup="true" CodeBehind="SubDivisionMaster.aspx.cs" Inherits="MAPS.Masters.SubDivisionMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="mainSection">
        <h1>
            <span class="heading">Sub Division</span></h1>
        <div class="butLink01">
            <a href="SubDivisionMasterNew.aspx" class="button">Create </a>
        </div>
        <div class="butLink02">
        </div>
        <div class="butLink03">
                    ...
                    <asp:GridView ID="GridView1" BackColor="White" BorderColor="#DEDFDE" OnRowDataBound="GridView1_RowDataBound"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField Visible="false">
                                <ItemTemplate>
                                    <asp:Label ID="lblId" runat="server" Text='<%# Eval("SubDIV_Id") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:BoundField DataField="SubDiv_EName" HeaderText="Name"></asp:BoundField>
                            <asp:BoundField DataField="Div_EName" HeaderText="Division"></asp:BoundField>
