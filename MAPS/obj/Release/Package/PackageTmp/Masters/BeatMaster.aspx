<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Site1.Master" AutoEventWireup="true" CodeBehind="BeatMaster.aspx.cs" Inherits="MAPS.Masters.BeatMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="mainSection">
        <h1>
            <span class="heading">Beat</span></h1>
        <div class="butLink01">
            <a href="BeatMasterNew.aspx" class="button">Create </a>
        </div>
        <div class="butLink02">
        </div>
        <div class="butLink03">
                    ...
                    <asp:GridView ID="GridView1" BackColor="White" BorderColor="#DEDFDE" OnRowDataBound="GridView1_RowDataBound"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField Visible="false">
                                <ItemTemplate>
                                    <asp:Label ID="lblId" runat="server" Text='<%# Eval("BEAT_ID") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:BoundField DataField="BEAT_ENAME" HeaderText="Name"></asp:BoundField>
                            <asp:BoundField DataField="RANGEASST_ENAME" HeaderText="Section"></asp:BoundField>
