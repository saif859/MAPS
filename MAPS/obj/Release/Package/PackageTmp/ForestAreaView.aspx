<%@ Page Title="View" Language="C#" MasterPageFile="~/Masters/Site1.Master" AutoEventWireup="true"
    CodeBehind="ForestAreaView.aspx.cs" EnableEventValidation="false" Inherits="MAPS.ForestAreaView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="mainSection">
        <table width="100%">
            <h1>
                <span class="heading">Export to Excel</span></h1>
            <tr>
                <td>
    ...
    <div class="perp_sheetbg">
        <div class="perp_sheet perp_sheet_width">
                            ...
                            <table class="perp_group" width="100%">
                                ...
                                <tr class="perp_group_cell">
                                    <td class="perp_group_cell perp_group_cell_label" align="left" width="20%">
                                        <asp:Label ID="Label2" class=" perp_label sa_text_right" runat="server" Text=" Circle :"></asp:Label>
                                    </td>
                                    <td align="left" colspan="2">
                                        <asp:Label ID="lblCircle" runat="server" Text="Label"></asp:Label>
                                    </td>
                                    <td align="left" colspan="2" width="20%">Division :
                                    </td>
                                ...
                                <tr class="perp_group_cell">
                                    ...
                                    <td align="left" colspan="2" width="20%">Village :
                                    </td>
                                    <td align="left" width="20%">
                                ...
                                <tr>
                                    <td align="left" width="20%">Area computed based on chainage and bearings :
                                    </td>
                                    <td align="left" colspan="2">
                                    ...
                                    <td align="left" colspan="2">Area computed based on field entry of GPS coordinates :
                                    </td>
                                    <td align="left" width="27%">
            ...
            Map generated on the chainage and bearings filled above<a href="Map.kml" runat="server" id="aKml" target="_blank" style="color: Blue;"> click to download KML file </a>
