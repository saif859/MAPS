...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table">
                <tbody>
                    ...
                    <tr class="perp_group_row">
                        ...
                        <td class="perp_group_cell">
                            <span class="perp_field perp_field_char">
                                <asp:DropDownList ID="ddlBlock" runat="server" CssClass="ddl">
                                </asp:DropDownList>
                            </span>
                        </td>
                    </tr>
                    ...
                    <tr class="perp_group_row">
                        ...
                        <td class="perp_group_cell">
                            <span class="perp_field perp_field_char">
                                <asp:TextBox ID="txtForestName" runat="server" class="form-control" placeholder="Forest Name"
    ...
    <div style="padding: 5px; color: #000; background: #f4f4f4; font-size: 12px;">
        <asp:RadioButton ID="rdFirstPillar" runat="server" Text="First Pillar Co-ordinates"
            class="rd" GroupName="rd" Checked="true" />&nbsp;<asp:RadioButton GroupName="rd" ID="rdReference"
                runat="server" Text="Reference Co-ordinates" class="rd" />
    </div>
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table">
    ...
    <div id="divTable">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table" id="tbl">
            <tbody>
            </tbody>
        </table>
    </div>
    <div style="float: left; clear: none; width: 100%;">
        <input id="btnSubmit" type="button" value="Submit" class="buttonM button-green" /><img
            id="imgLoader" src="images/loader.gif" /></div>
            ...
            $("#btnSubmit").click(function (evt) {
                ...
                if ($('#form1').validate().form()) {
                    ...
                    for (i; i <= numOfPillar; i++) {
                        ...
                        json.forestCoordinates.push({ pillarNo: $('#txtPillarNo' + i).val(), latitude: $('#txtLatitude' + i).val(), longitude: $('#txtLongitude' + i).val(), forwardBearings: $('#txtBearing' + i).val(), backBearings: $('#txtBackBearing' + i).val(), backDistanceInMeter: $('#txtDistance' + i).val(), backDistanceInChain: $('#txtDistanceInChain' + i).val(),bearingDifference:$('#txtBearingDifference' + i).val() });
                    }
